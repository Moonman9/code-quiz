...
var questions = [
    {
    ...
    },
      {
        ...
        options: ["All of the Below", "For", "While", "Do-while Loops"],
      ...
      {
        title: "What is the greatest anime of all time?",
        options: ["Demon Slayer", "One Piece", "Attack on Titan", "My Hero Academia"],
        answer: "One Piece"
      }
    ];